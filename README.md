...
- [Zhukov Georgiy's original nvc-wasm experiment](https://github.com/zhugeo/nvc-wasm)
  which mapped out the dependency space and concluded it would need "massive
